            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "areas": {
                        "type": "string",
                        "enum": ["Hu", "So", "Sc"],
                        "description": "The specified area for a course: Humanities (Hu), Social Science (So), Science (Sc). Don't make assumptions.",
                    },
                    "skills": {
                        "type": "string",
                        "enum": ["QR", "WR"],
                        "description": "The specified skills for a course: Quantitative Reasoning (QR), Writing (WR). Don't make assumptions.",
                    },
                },
            },
        },
